...
Blockly.Msg.SSERIAL_Read="读串口(字节)";
Blockly.Msg.SSERIAL_Println="输出(换行)";
Blockly.Msg.SSERIAL_Print="输出(不换行)";
Blockly.Msg.SSERIAL_Write="写入串口"
Blockly.Msg.SSERIAL_Avai="软串口可用?";
Blockly.Msg.SSerial_Print_Format="按进制输出";
Blockly.Msg.SSERIAL_ReadNum="读串口(数字)";
Blockly.Msg.SSERIAL_ReadString="读串口(字符串)";
Blockly.Msg.SSERIAL_Readlf="直到行尾";

// SERIAL 
Blockly.Msg.SERIAL_Init="初始化串口 ";
Blockly.Msg.SERIAL_TX="TX针脚";
Blockly.Msg.SERIAL_RX="RX针脚";
Blockly.Msg.SERIAL_BAUD="波特率";
Blockly.Msg.SERIAL_Read="读串口（字节）";
Blockly.Msg.SERIAL_Println="输出(换行)";
Blockly.Msg.SERIAL_Print="输出(不换行)";
Blockly.Msg.SERIAL_Write="写入串口"
Blockly.Msg.SERIAL_Avai="串口可用?";
Blockly.Msg.Serial_Print_Format="按进制输出";
Blockly.Msg.SERIAL_ReadNum="读串口(数字)";
Blockly.Msg.SERIAL_ReadString="读串口(字符串)";
