...
Blockly.Msg.LCD_SHIELD_PRINT_TEXT = "开启显示";
...
Blockly.Msg.LCD_raz_tooltip = "清屏";
...
Blockly.Msg.OTTO_HOME_TEXT = "初始化Otto";
...
Blockly.Msg.SSERIAL_BT_Init="初始化蓝牙(软串口)";
Blockly.Msg.ESP32Bluetooth = "Init Bluetooth - ESP32 Bluetooth Serial";
Blockly.Msg.SSERIAL_BT_TX="TX针脚";
Blockly.Msg.SSERIAL_BT_RX="RX针脚";
Blockly.Msg.SSERIAL_BT_BAUD="波特率";
Blockly.Msg.SSERIAL_BT_Read="读蓝牙(字节)";
Blockly.Msg.SSERIAL_BT_Println="输出(换行)";
Blockly.Msg.SSERIAL_BT_Print="输出(不换行)";
Blockly.Msg.SSERIAL_BT_Write="蓝牙写入"
Blockly.Msg.SSERIAL_BT_Avai="蓝牙可用?";
Blockly.Msg.SSerial_BT_Print_Format="按进制输出";
Blockly.Msg.SSERIAL_BT_ReadNum="读蓝牙(数字)";
Blockly.Msg.SSERIAL_BT_ReadString="读蓝牙(字符串)";
Blockly.Msg.SSERIAL_BT_Readlf="直到行尾";

// SOFTWARE SERIAL 
Blockly.Msg.SSERIAL_Init="初始化软串口";
Blockly.Msg.SSERIAL_TX="TX针脚";
Blockly.Msg.SSERIAL_RX="RX针脚";
Blockly.Msg.SSERIAL_BAUD="波特率";
Blockly.Msg.SSERIAL_Read="读软串口(字节)";
Blockly.Msg.SSERIAL_Println="软串口输出(换行)";
Blockly.Msg.SSERIAL_Print="软串口输出(不换行)";
Blockly.Msg.SSERIAL_Write="写入软串口"
Blockly.Msg.SSERIAL_Avai="软串口可用?";
Blockly.Msg.SSerial_Print_Format="软串口按进制输出";
Blockly.Msg.SSERIAL_ReadNum="读软串口(数字)";
Blockly.Msg.SSERIAL_ReadString="读软串口(字符串)";
Blockly.Msg.SSERIAL_Readlf="直到行尾";

// SERIAL 
Blockly.Msg.SERIAL_Init="初始化硬串口 ";
Blockly.Msg.SERIAL_TX="TX针脚";
Blockly.Msg.SERIAL_RX="RX针脚";
Blockly.Msg.SERIAL_BAUD="波特率";
Blockly.Msg.SERIAL_Read="读硬串口（字节）";
Blockly.Msg.SERIAL_Println="硬串口输出(换行)";
Blockly.Msg.SERIAL_Print="硬串口输出(不换行)";
Blockly.Msg.SERIAL_Write="写入硬串口"
Blockly.Msg.SERIAL_Avai="硬串口可用?";
Blockly.Msg.Serial_Print_Format="硬串口按进制输出";
Blockly.Msg.SERIAL_ReadNum="读硬串口(数字)";
Blockly.Msg.SERIAL_ReadString="读硬串口(字符串)";
Blockly.Msg.SERIAL_Readlf="直到行尾";
...
Blockly.Msg.OLED_IconName = "图标名(bmp):";
Blockly.Msg.OLED_ValueList = "值(十六进制数组)";
Blockly.Msg.OLED_DrawiconName = "画图标(bmp)";
...
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_LOWERCASE = "小写";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_TITLECASE = "首字母大写";
Blockly.Msg.TEXT_CHANGECASE_OPERATOR_UPPERCASE = "大写";
Blockly.Msg.TEXT_CHANGECASE_TOOLTIP = "Return a copy of the text in a different case.";
Blockly.Msg.TEXT_CHARAT_FIRST = "的首字符";
Blockly.Msg.TEXT_CHARAT_FROM_END = "的字符 从末尾起第";
Blockly.Msg.TEXT_CHARAT_FROM_START = "的字符 位置为";
Blockly.Msg.TEXT_CHARAT_HELPURL = "https://github.com/google/blockly/wiki/Text#extracting-text";
Blockly.Msg.TEXT_CHARAT_INPUT_INTEXT = "文本";
Blockly.Msg.TEXT_CHARAT_LAST = "的最后一个字符";
...
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_END = "到倒数第";
Blockly.Msg.TEXT_GET_SUBSTRING_END_FROM_START = "到";
Blockly.Msg.TEXT_GET_SUBSTRING_END_LAST = "到尾";
Blockly.Msg.TEXT_GET_SUBSTRING_HELPURL = "https://github.com/google/blockly/wiki/Text#extracting-a-region-of-text";
Blockly.Msg.TEXT_GET_SUBSTRING_INPUT_IN_TEXT = "在文本";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FIRST = "get substring from the first letter";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_END = "get substring from letter # from end";
Blockly.Msg.TEXT_GET_SUBSTRING_START_FROM_START = "中获取子字符串从位置";
Blockly.Msg.TEXT_GET_SUBSTRING_TAIL = "";
Blockly.Msg.TEXT_GET_SUBSTRING_TOOLTIP = "Returns a specified portion of the text.";
Blockly.Msg.TEXT_INDEXOF_HELPURL = "https://github.com/google/blockly/wiki/Text#finding-text";
Blockly.Msg.TEXT_INDEXOF_INPUT_INTEXT = "在文本";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_FIRST = "中查找首次出现的位置";
Blockly.Msg.TEXT_INDEXOF_OPERATOR_LAST = "中查找最后出现的位置";
